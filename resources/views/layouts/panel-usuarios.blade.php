...
<body>
    <div id="app">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="{{ route('usuarios.create') }}">Alta de usuarios</a>
          <a class="dropdown-item" href="{{ route('list') }}">Modificación y baja de usuarios</a>
        </div>
      </li>
        ...
        <script src="{{ asset('web/jquery/js/jquery-3.1.1.js') }}"></script>
